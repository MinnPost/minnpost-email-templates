...
<html>
	<head>
		...
		<title><?php echo 'Welcome to MinnPost'; ?></title>
...
@media only screen and (max-width: 600px) {
	...
	<span style="display: none !important; font-size: 0; color: #fff;"> <!-- gmail only takes display none if it has !important; outlook still doesn't care -->
		<?php echo 'Welcome to your MinnPost.com website account.'; ?>
	</span>
											...
											<table cellpadding="0" cellspacing="0" class="contents" style="border-spacing: 0; margin: 0; padding: 0; font-family: Helvetica, Arial, Geneva, sans-serif; color: #1a1818; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; width: 100%; font-size: 16px; text-align: left;">
												<tr>
													<td style="border-collapse: collapse; margin: 0; padding: 0; max-height: 90px; mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-size: 0; line-height: 0px;" valign="bottom">
														<a href="https://www.minnpost.com/" style="color: #801019; text-decoration: none;"><img src="https://www.minnpost.com/wp-content/uploads/sites/default/themes/siteskin/inc/images/newsletter-logo-daily.png" alt="<?php echo 'MinnPost'; ?>" width="390" height="90" align="left" style="height: auto; margin: 0; padding: 0; border: 0 none; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 390px; max-height: 90px; display: block; vertical-align: bottom;" /></a>
													</td>
												</tr>
											</table>
										</td>
										...
										<table cellpadding="0" cellspacing="0" class="bodyTable" style="border-spacing: 0; margin: 0; padding: 0; font-family: Helvetica, Arial, Geneva, sans-serif; color: #1a1818; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; text-align: left;">
											<tr>
												<td valign="top" style="border-collapse: collapse; margin: 0; padding: 0;">
													<div>
														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">Hi <?php echo 'Jonathan Stegall' ?>,</p>
														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">Thanks for creating your MinnPost.com user account. You can log in with your email address, <a href="mailto:<?php echo 'jstegall@minnpost.com'; ?>" style="color: #801019; text-decoration: none;"><?php echo 'jstegall@minnpost.com'; ?></a>. Use your account to manage your reading and communication preferences, and to see new stories that match your interests.</p>

														<p style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: 16px; line-height: 20.787px; margin: 0 0 10px; padding: 0;">If you have not set up your preferences yet, you can <a href="<?php echo 'https://www.minnpost.com/user/preferences/'; ?>" style="color: #801019; text-decoration: none;">do that now</a>.</p>
							...
							<table cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0; margin: 0; padding: 0; font-family: Helvetica, Arial, Geneva, sans-serif; color: #1a1818; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse;">
								<tr>
									...
									<div class="footer-bottom" style="padding: 10px 0; text-align: center;">
										...
										<?php
										$footer_message = 'MinnPost | P.O. Box 18438 | Minneapolis, MN 55418 | <a href="tel:612.455.6950">612.455.6950</a>';
										if ( '' !== $footer_message ) :
											?>
